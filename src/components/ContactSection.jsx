  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      toast({
        ...
        description: "Obrigado pela mensagem, te retornarei em breve!",
      });
      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="space-y-8">
            ...
            <div className="pt-8">
              <h4 className="font-medium mb-4">Social Medias</h4>
              <div className="flex space-x-4 justify-center">
                <a
                  href="https://www.linkedin.com/in/lucas-gomes-tambasco-296747206/"
                  target="_blank"
                >
                  <Linkedin />
                </a>
                <a href="https://www.instagram.com/lucas.gtm/" target="_blank">
                  <Instagram />
                </a>
              </div>
            </div>
          ...
          >
            ...
            <form action="" className="space-y-6">
              ...
              <button
                ...
                className={cn(
                  "cosmic-button w-full y-full flex items-center justify-center gap-2"
                )}
              >
